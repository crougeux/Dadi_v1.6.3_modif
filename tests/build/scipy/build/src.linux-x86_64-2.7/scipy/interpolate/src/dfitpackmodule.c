...
/*frompyobj*/
  ...
  capi_teta_tmp = array_from_pyobj(PyArray_DOUBLE,teta_Dims,teta_Rank,capi_teta_intent,teta_capi);
  if (capi_teta_tmp == NULL) {
    ...
    teta = (double *)(capi_teta_tmp->data);
  ...
  capi_tt_tmp = array_from_pyobj(PyArray_DOUBLE,tt_Dims,tt_Rank,capi_tt_intent,Py_None);
  if (capi_tt_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(dfitpack_error,"failed in converting hidden `tt' of dfitpack.spherfit_smth to C/Fortran array" );
  } else {
    tt = (double *)(capi_tt_tmp->data);
  ...
  capi_tp_tmp = array_from_pyobj(PyArray_DOUBLE,tp_Dims,tp_Rank,capi_tp_intent,Py_None);
  if (capi_tp_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(dfitpack_error,"failed in converting hidden `tp' of dfitpack.spherfit_smth to C/Fortran array" );
  } else {
    tp = (double *)(capi_tp_tmp->data);
...
/*frompyobj*/
  ...
  capi_tt_tmp = array_from_pyobj(PyArray_DOUBLE,tt_Dims,tt_Rank,capi_tt_intent,tt_capi);
  if (capi_tt_tmp == NULL) {
    if (!PyErr_Occurred())
  ...
  capi_tp_tmp = array_from_pyobj(PyArray_DOUBLE,tp_Dims,tp_Rank,capi_tp_intent,tp_capi);
  if (capi_tp_tmp == NULL) {
    if (!PyErr_Occurred())
...
/*frompyobj*/
  ...
  capi_iopt_tmp = array_from_pyobj(PyArray_INT,iopt_Dims,iopt_Rank,capi_iopt_intent,iopt_capi);
  ...
  capi_ider_tmp = array_from_pyobj(PyArray_INT,ider_Dims,ider_Rank,capi_ider_intent,ider_capi);
  ...
  capi_tv_tmp = array_from_pyobj(PyArray_DOUBLE,tv_Dims,tv_Rank,capi_tv_intent,Py_None);
  if (capi_tv_tmp == NULL) {
    if (!PyErr_Occurred())
