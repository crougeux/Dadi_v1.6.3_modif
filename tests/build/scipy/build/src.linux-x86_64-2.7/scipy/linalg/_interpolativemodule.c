 ...
 * Generation date: Wed Mar  5 11:47:39 2014
 * $Revision:$
 * $Date:$
...
/*pyobjfrom*/
  if (cb_matveca_in_idz__user__routines_nofargs>capi_i) {
    PyArrayObject *tmp_arr = (PyArrayObject *)PyArray_New(&PyArray_Type,1,x_Dims,PyArray_CDOUBLE,NULL,(char*)x,0,NPY_FARRAY,NULL); /*XXX: Hmm, what will destroy this array??? */
...
/*frompyobj*/
  if (capi_j>capi_i) {
    PyArrayObject *rv_cb_arr = NULL;
    if ((capi_tmp = PyTuple_GetItem(capi_return,capi_i++))==NULL) goto capi_fail;
    rv_cb_arr =  array_from_pyobj(PyArray_CDOUBLE,y_Dims,1,F2PY_INTENT_IN
,capi_tmp);
    if (rv_cb_arr == NULL) {
      fprintf(stderr,"rv_cb_arr is NULL\n");
      goto capi_fail;
...
/*frompyobj*/
  ...
  capi_rnorms_tmp = array_from_pyobj(PyArray_DOUBLE,rnorms_Dims,rnorms_Rank,capi_rnorms_intent,Py_None);
  if (capi_rnorms_tmp == NULL) {
    ...
    rnorms = (double *)(capi_rnorms_tmp->data);

  /* Processing variable list */
  list_Dims[0]=n;
  capi_list_intent |= F2PY_INTENT_OUT|F2PY_INTENT_HIDE;
  capi_list_tmp = array_from_pyobj(PyArray_INT,list_Dims,list_Rank,capi_list_intent,Py_None);
...
/*frompyobj*/
  ...
  capi_col_tmp = array_from_pyobj(PyArray_DOUBLE,col_Dims,col_Rank,capi_col_intent,col_capi);
  ...
  capi_approx_tmp = array_from_pyobj(PyArray_DOUBLE,approx_Dims,approx_Rank,capi_approx_intent,Py_None);
  if (capi_approx_tmp == NULL) {
    ...
    approx = (double *)(capi_approx_tmp->data);

  /* Processing variable proj */
  proj_Dims[0]=krank,proj_Dims[1]=n-krank;
  capi_proj_intent |= F2PY_INTENT_IN;
  capi_proj_tmp = array_from_pyobj(PyArray_DOUBLE,proj_Dims,proj_Rank,capi_proj_intent,proj_capi);
  if (capi_proj_tmp == NULL) {
    ...
    proj = (double *)(capi_proj_tmp->data);
...
/*frompyobj*/
  ...
  capi_col_tmp = array_from_pyobj(PyArray_DOUBLE,col_Dims,col_Rank,capi_col_intent,Py_None);
  if (capi_col_tmp == NULL) {
    if (!PyErr_Occurred())
...
/*frompyobj*/
  ...
  capi_ra_tmp = array_from_pyobj(PyArray_DOUBLE,ra_Dims,ra_Rank,capi_ra_intent,ra_capi);
  if (capi_ra_tmp == NULL) {
    if (!PyErr_Occurred())
...
/*frompyobj*/
  ...
  capi_winit_tmp = array_from_pyobj(PyArray_DOUBLE,winit_Dims,winit_Rank,capi_winit_intent,winit_capi);
  if (capi_winit_tmp == NULL) {
    ...
    winit = (double *)(capi_winit_tmp->data);
...
if(F2PyCapsule_Check(matvect_capi)) {
  ...
  capi_ra_tmp = array_from_pyobj(PyArray_DOUBLE,ra_Dims,ra_Rank,capi_ra_intent,Py_None);
  if (capi_ra_tmp == NULL) {
    if (!PyErr_Occurred())
...
/*frompyobj*/
  ...
  capi_proj_tmp = array_from_pyobj(PyArray_DOUBLE,proj_Dims,proj_Rank,capi_proj_intent,Py_None);
  if (capi_proj_tmp == NULL) {
    if (!PyErr_Occurred())
...
/*frompyobj*/
  ...
  y_Dims[0]=n;
  capi_y_intent |= F2PY_INTENT_OUT|F2PY_INTENT_HIDE;
  capi_y_tmp = array_from_pyobj(PyArray_CDOUBLE,y_Dims,y_Rank,capi_y_intent,Py_None);
  if (capi_y_tmp == NULL) {
    if (!PyErr_Occurred())
  ...
  w_Dims[0]=17 * m + 70;
  capi_w_intent |= F2PY_INTENT_IN;
  capi_w_tmp = array_from_pyobj(PyArray_CDOUBLE,w_Dims,w_Rank,capi_w_intent,w_capi);
  if (capi_w_tmp == NULL) {
    if (!PyErr_Occurred())
...
/*frompyobj*/
  ...
  ;
  capi_col_intent |= F2PY_INTENT_IN;
  capi_col_tmp = array_from_pyobj(PyArray_CDOUBLE,col_Dims,col_Rank,capi_col_intent,col_capi);
  if (capi_col_tmp == NULL) {
    if (!PyErr_Occurred())
    ...
    col = (complex_double *)(capi_col_tmp->data);
  ...
  approx_Dims[0]=m,approx_Dims[1]=n;
  capi_approx_intent |= F2PY_INTENT_OUT|F2PY_INTENT_HIDE;
  capi_approx_tmp = array_from_pyobj(PyArray_CDOUBLE,approx_Dims,approx_Rank,capi_approx_intent,Py_None);
  if (capi_approx_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(_interpolative_error,"failed in converting hidden `approx' of _interpolative.idz_reconid to C/Fortran array" );
  } else {
    approx = (complex_double *)(capi_approx_tmp->data);

  /* Processing variable proj */
  proj_Dims[0]=krank,proj_Dims[1]=n-krank;
  capi_proj_intent |= F2PY_INTENT_IN;
  capi_proj_tmp = array_from_pyobj(PyArray_CDOUBLE,proj_Dims,proj_Rank,capi_proj_intent,proj_capi);
  if (capi_proj_tmp == NULL) {
    if (!PyErr_Occurred())
    ...
    proj = (complex_double *)(capi_proj_tmp->data);
...
/*frompyobj*/
  ...
  col_Dims[0]=m,col_Dims[1]=krank;
  capi_col_intent |= F2PY_INTENT_OUT|F2PY_INTENT_HIDE;
  capi_col_tmp = array_from_pyobj(PyArray_CDOUBLE,col_Dims,col_Rank,capi_col_intent,Py_None);
  if (capi_col_tmp == NULL) {
    if (!PyErr_Occurred())
...
/*frompyobj*/
  ...
  v_Dims[0]=n,v_Dims[1]=krank;
  capi_v_intent |= F2PY_INTENT_OUT|F2PY_INTENT_HIDE;
  capi_v_tmp = array_from_pyobj(PyArray_CDOUBLE,v_Dims,v_Rank,capi_v_intent,Py_None);
  if (capi_v_tmp == NULL) {
    if (!PyErr_Occurred())
...
if(F2PyCapsule_Check(matvec_capi)) {
  ...
  u_Dims[0]=m;
  capi_u_intent |= F2PY_INTENT_IN|F2PY_OPTIONAL;
  capi_u_tmp = array_from_pyobj(PyArray_CDOUBLE,u_Dims,u_Rank,capi_u_intent,u_capi);
  if (capi_u_tmp == NULL) {
    if (!PyErr_Occurred())
...
/*frompyobj*/
  ...
  ;
  capi_ra_intent |= F2PY_INTENT_IN|F2PY_INTENT_OUT;
  capi_ra_tmp = array_from_pyobj(PyArray_CDOUBLE,ra_Dims,ra_Rank,capi_ra_intent,ra_capi);
  if (capi_ra_tmp == NULL) {
    if (!PyErr_Occurred())
    ...
    ra = (complex_double *)(capi_ra_tmp->data);
...
/*frompyobj*/
  ...
  winit_Dims[0]=17 * m + 70;
  capi_winit_intent |= F2PY_INTENT_IN;
  capi_winit_tmp = array_from_pyobj(PyArray_CDOUBLE,winit_Dims,winit_Rank,capi_winit_intent,winit_capi);
  if (capi_winit_tmp == NULL) {
    if (!PyErr_Occurred())
    ...
    winit = (complex_double *)(capi_winit_tmp->data);
...
if(F2PyCapsule_Check(matveca_capi)) {
  ...
  ra_Dims[0]=2*n*min(m,n);
  capi_ra_intent |= F2PY_INTENT_OUT|F2PY_INTENT_HIDE;
  capi_ra_tmp = array_from_pyobj(PyArray_CDOUBLE,ra_Dims,ra_Rank,capi_ra_intent,Py_None);
  if (capi_ra_tmp == NULL) {
    if (!PyErr_Occurred())
...
/*frompyobj*/
  ...
  proj_Dims[0]=max(krank*(n-krank),1);
  capi_proj_intent |= F2PY_INTENT_OUT|F2PY_INTENT_HIDE;
  capi_proj_tmp = array_from_pyobj(PyArray_CDOUBLE,proj_Dims,proj_Rank,capi_proj_intent,Py_None);
  if (capi_proj_tmp == NULL) {
    if (!PyErr_Occurred())
...
#if PY_VERSION_HEX >= 0x03000000
#define RETVAL m
PyObject *PyInit__interpolative(void) {
#else
#define RETVAL
