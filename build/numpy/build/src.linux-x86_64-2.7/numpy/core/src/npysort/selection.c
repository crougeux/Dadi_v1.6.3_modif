...
int
introselect_string(npy_char *start, npy_intp num, npy_intp kth, PyArrayObject *arr)
{
    return quicksort_string(start, num, arr);
}

int
aintroselect_string(npy_char *v, npy_intp* tosort, npy_intp num, npy_intp kth, void *null)
{
    return aquicksort_string(v, tosort, num, null);
}
...
int
introselect_unicode(npy_ucs4 *start, npy_intp num, npy_intp kth, PyArrayObject *arr)
{
    return quicksort_unicode(start, num, arr);
}

int
aintroselect_unicode(npy_ucs4 *v, npy_intp* tosort, npy_intp num, npy_intp kth, void *null)
{
    return aquicksort_unicode(v, tosort, num, null);
}
